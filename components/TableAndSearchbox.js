    ...
    <table className="w-full text-center text-white ">
      <tbody className="">
        ...
        <tr className="bg-red-600">
          <th className="py-1 px-2 border-white xs:border-r-2 border-b-2 table-cell">
            Übung
          </th>

          <th className="py-1 px-2 border-white ss:border-r-2 hidden ss:table-cell border-b-2">
            Übungstyp
          </th>

          <th className="py-1 px-2 border-white mm:border-r-2 hidden mm:table-cell border-b-2">
            Muskelgruppe
          </th>

          <th className="py-1 px-2 border-white sm:border-r-2 hidden sm:table-cell border-b-2">
            Schwierigkeit
          </th>
          <th className="py-1 px-2 border-white border-b-2 hidden md:table-cell">
            Tags
          </th>
        </tr>
        {uebungen &&
            ...
            .map((uebung) => (
              <Link href={`/uebungen/${uebung.fields.slug}`}>
                <tr className="bg-red-200 hover:bg-red-600 text-gray-900 hover:text-white cursor-pointer">
                  <td className="py-10 px-2 border-white xs:border-r-2 border-b-2 table-cell">
                    <div>{uebung.fields.uebungsname}</div>
                  </td>

                  <td className="py-10 px-2 border-white ss:border-r-2 hidden ss:table-cell border-b-2">
                    {uebung.fields.uebungstyp}
                  </td>

                  <td className="py-10 px-2 border-white mm:border-r-2 hidden mm:table-cell border-b-2">
                    {uebung.fields.muskelgruppe.join(', ')}
                  </td>

                  <td className="py-10 px-2 border-gray-50 sm:border-r-2 hidden sm:table-cell border-b-2">
                    {star.repeat(uebung.fields.schwierigkeitsgrad)}
                  </td>

                  <td className="py-10 px-2 border-white border-b-2 hidden md:table-cell">
